<template>
  <div class="text-base pt-20 md:pt-4 p-4 pl-4 md:pl-48 text-white justify-center text-justify">
    <h1>Privacy Policy for Bich Bui Photos</h1>

    <p>
      At Bich Bui Photos, accessible from https://bichbui.com, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that is collected and recorded by Bich Bui
      Photos and how we use it.
    </p>
    ...
    <p>
      Bich Bui Photos follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <p>
      Like any other website, Bich Bui Photos uses 'cookies'. These cookies are used to store information including
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Bich Bui Photos.</P>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on Bich Bui Photos, which are sent directly to users'
    ...
    <p>
      Note that Bich Bui Photos has no access to or control over these cookies that are used by third-party advertisers.
    </p>

    <h2>Third Party Privacy Policies</h2>

    <p>
      Bich Bui Photos's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>
      Bich Bui Photos does not knowingly collect any Personal Identifiable Information from children under the age of
    ...
    <p>
      ...
      the information that they shared and/or collect in Bich Bui Photos. This policy is not applicable to any
